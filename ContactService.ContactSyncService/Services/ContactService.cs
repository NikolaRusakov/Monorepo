...
public class ContactService : IContactService
{
    ...
    {
        var contacts = await _context.VCards
    ...
    {
        var contact = await _context.VCards
            .Include(v => v.Telephones)
    ...
    public async Task<VCardDto> CreateContactAsync(CreateVCardRequest request)
    {
        var vcard = new VCard
        {
            Language = request.Language != null ? new Language
            {
                Value = request.Language.Value,
                Preference = request.Language.Preference
            } : null,
            
            Organization = request.Organization != null ? new Organization
            {
            ...
            Email = request.Email != null ? new Email
            {
                Type = request.Email.Type,
                Address = request.Email.Address
            } : null,
            
            Geography = request.Geography != null ? new Geography
            {
            ...
            PublicKey = request.PublicKey != null ? new PublicKey
            {
            ...
            Url = request.Url != null ? new Url
            {
                Type = request.Url.Type,
                Address = request.Url.Address
            } : null
        };
        ...
        var createdContact = await _context.VCards
            .Include(v => v.Telephones)
    ...
    public async Task<VCardDto?> UpdateContactAsync(Guid id, UpdateVCardRequest request)
    {
        ...
        // Update properties
        vcard.Language = request.Language != null ? new Language
        {
            Value = request.Language.Value,
            Preference = request.Language.Preference
        } : null;
        
        vcard.Organization = request.Organization != null ? new Organization
        {
            Name = request.Organization.Name,
            Type = request.Organization.Type
        } : null;
        
        vcard.Address = request.Address != null ? new Address
        {
            Type = request.Address.Type,
            PoBox = request.Address.PoBox,
            ExtendedAddress = request.Address.ExtendedAddress,
        ...
        vcard.Email = request.Email != null ? new Email
        {
            Type = request.Email.Type,
            Address = request.Email.Address
        } : null;
        
        vcard.Geography = request.Geography != null ? new Geography
        {
            Type = request.Geography.Type,
            Latitude = request.Geography.Latitude,
            Longitude = request.Geography.Longitude
        ...
        vcard.PublicKey = request.PublicKey != null ? new PublicKey
        {
            Type = request.PublicKey.Type,
            ValueType = request.PublicKey.ValueType,
            Uri = request.PublicKey.Uri
        ...
        vcard.Url = request.Url != null ? new Url
        {
            Type = request.Url.Type,
            Address = request.Url.Address
        } : null;
    ...
    private static VCardDto MapToDto(VCard vcard)
    {
        return new VCardDto(
            vcard.Id,
            vcard.Language != null ? new LanguageDto(vcard.Language.Value, vcard.Language.Preference) : null,
            vcard.Organization != null ? new OrganizationDto(vcard.Organization.Name, vcard.Organization.Type) : null,
            vcard.Address != null ? new AddressDto(
                vcard.Address.Type,
                vcard.Address.PoBox,
            ...
            vcard.Telephones.Select(t => new TelephoneDto(
                t.Id,
                t.Value,
                t.ValueType,
                t.TypeList,
            ...
            vcard.Geography != null ? new GeographyDto(vcard.Geography.Type, vcard.Geography.Latitude, vcard.Geography.Longitude) : null,
            vcard.PublicKey != null ? new PublicKeyDto(vcard.PublicKey.Type, vcard.PublicKey.ValueType, vcard.PublicKey.Uri) : null,
            vcard.Timezone,
