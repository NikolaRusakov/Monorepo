...
namespace VCardAPI
{
    ...
    public class VCardValidator : AbstractValidator<VCard>
    {
        public VCardValidator()
        {
            ...
            RuleFor(x => x.Telephones)
                .NotNull()
                .WithMessage("Telephones list cannot be null");
    ...
    public class AddressValidator : AbstractValidator<Address>
    {
        public AddressValidator()
        {
            RuleFor(x => x.Type)
                ...
                .Must(type => new[] { "work", "home", "postal", "domestic", "international" }.Contains(type.ToLower()))
                .WithMessage("Address type must be one of: work, home, postal, domestic, international");
    ...
    public class TelephoneValidator : AbstractValidator<Telephone>
    {
        public TelephoneValidator()
        {
            ...
            RuleFor(x => x.Type)
                .NotNull()
                .WithMessage("Type list cannot be null");

            RuleForEach(x => x.Type)
                .Must(type => new[] { "work", "home", "text", "voice", "fax", "cell", "video", "pager", "textphone" }.Contains(type?.ToLower()))
                .WithMessage("Each type must be one of: work, home, text, voice, fax, cell, video, pager, textphone");
    ...
    public static class ProgramConfiguration
    {
        public static void ConfigureServices(WebApplicationBuilder builder)
        {
            ...
            builder.Services.AddValidatorsFromAssemblyContaining<VCardValidator>();
