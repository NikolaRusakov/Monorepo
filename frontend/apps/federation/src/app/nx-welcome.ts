...
import { NxRemoteComponent } from './nx-remote';

@Component({
  selector: 'app-nx-welcome',
  imports: [CommonModule, NxRemoteComponent],
  template: `<div>
    <nx-remote-component></nx-remote-component>
    <!-- <h1>Welcome to federation!</h1> -->
  </div>`,
  /*   template: `
    <!--
     * * * * * * * * * * * * * * * * * * * * * * * * * * * *
...
nx run-many -t build test lint</pre>
          ...
          <details>
            ...
            <pre>nx show project federation</pre>
          </details>
